...
export class LayoutService {
  ...
  openPageCreateAnnonce() {
    this.router.navigate(['/annonce/creation']);
  }

  openPageSearch() {
    //this.router.navigate(['/ventes/offres']);
    this.router.navigate(['/search'], { queryParams: { category: '1', locations: 'all' } });
  }

  // openPageVentesOffres() {
  //   //this.router.navigate(['/ventes/offres']);
  //   this.router.navigate(['/search'], { queryParams: { category: '1', locations: 'all' } });
  // }

  // openPageLocationsOffres() {
  //   //this.router.navigate(['/locations/offres']);
  //   this.router.navigate(['/search'], { queryParams: { category: '2', locations: 'all' } });
  // }

  // openPageColocationsSearch() {
  //   //this.router.navigate(['/search']);
  //   this.router.navigate(['/search'], { queryParams: { category: '3', locations: 'all' } });
  // }

  // openPageBureauxCommercesSearch() {
  //   //this.router.navigate(['/search']);
  //   this.router.navigate(['/search'], { queryParams: { category: '4', locations: 'all' } });
  // }
}
